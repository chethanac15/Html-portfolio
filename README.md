This repository contains an example program of a basic HTML portfolio. It is designed to help learners create a personal portfolio website using fundamental HTML concepts. The repository includes:
